  ...
  Vue.component('tr-tray', {
      ...
      props:    [
    	...
    	xtemplate: `<div class="card card-draggable  card-resizable" >
                    ...
                    <div class="card-body" ref="el-scrollable">
                      <slot />
                    </div>
                  </div>
                `,
...
<slot />
      ...
      xtemplate: `<div class="card card-draggable card-resizable" >
							<div class="card-main" >
								...
								<div class="card-inner collapse in" id="{{ _uid }}" ref="el-scrollable" style="overflow:scroll;">
 ...
 //<component v-for="(windex, item) in items" :index="windex" :index="$index" :bitmap="item" is="tr-item"></component>
  Vue.component('j-collection', {
    ...
    template: `<div class="collection-container">
                <div class="collection-sortable" ref="mylist">
...
Vue.component('j-bitmap', {
  ...
  template: '<div class="widget widget-bitmap">' +
    ...
    '<div class="canvas_key"><canvas ref="canvas1"></canvas></div>' +
  ...
  ready: function () {
    ...
    //
    //      // Update canvas
    //      this.$refs.canvas1.getContext('2d').putImageData( bitmap.imageData, 0, 0 );
    //
    //      // Create helper
